...
FatesWS.prototype.identity=function(a,b){console.log(b);b={id:a.id,token:a.token,send_all:a.sendAll,send_none:a.sendNone,bot:a.bot};console.log({identityPayload:b});a.websocket.send(JSON.stringify(b))};FatesWS.prototype.event=function(a,b){console.log(b)};
