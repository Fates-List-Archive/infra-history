...
```json
{
    "id": "141b0486-bd76-4e57-81ca-f3e5f79bcd58",
    "reply": false,
    "star_rating": "0",
    "review_text": "",
    "votes": {
...
```json
{
    "rid": "7882bf61-ec45-498f-86d1-e3ed699f7b3e"
}
```
...
```json
{
    "rid": "6ff25b89-2db6-4e34-b326-5e298d1f3369"
}
```
...
```json
{
    "id": "4d5d73e2-5f33-4ea8-8bc3-23e55cbdb23b",
    "target_type": 0
}
```
