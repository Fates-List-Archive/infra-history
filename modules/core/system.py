...
class FatesListRequestHandler(BaseHTTPMiddleware):  # pylint: disable=too-few-public-methods
    ...
    async def _dispatcher(self, path, request, call_next):
        ...
        response.headers["Content-Security-Policy"] = "default-src 'none'; connect-src 'self' https://discord.com; script-src https: 'unsafe-inline'; img-src https: data:; font-src https: data:; child-src https: blob:; style-src https: 'unsafe-inline'; object-src 'none'; frame-ancestors https://docs.fateslist.xyz https://apidocs.fateslist.xyz; base-uri 'none'; report-uri /fates/csp"
